...
<script type="text/javascript">
    ...
    $(".dept_edit_btn").click(function () {
        ...
        dept_name = $(this).parent().parent().find("td:eq(1)").text();
        dept_leader = $(this).parent().parent().find("td:eq(2)").text();
        ...
        //     }
        // });
        $("#update_deptName").val(dept_name);
        $("#update_deptLeader").val(dept_leader);
    });
